...
export default class Utils {
    ...
    static async lockedReconnect() {
        await BEAM.api.lockedReconnect({
            apiver: InitParams["api_version"] || "current",
            apivermin: InitParams["min_api_version"] || "",
    ...
    static handleApiResult (json) {
        ...
        try
        {
            ...
            if (answer.is_locked !== undefined && !answer.is_locked){
